...
4. Have no Docker installed or a Docker with api version >= 1.26.
3. Have access to a Docker registry service (e.g., [Docker hub](https://docs.docker.com/docker-hub/))
